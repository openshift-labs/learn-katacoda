...
ssh root@host01 'ln -s ~/intro-katacoda/intro-openshift/container-internals-lab-2/assets ~/assets'
ssh root@host01 'git clone https://github.com/fatherlinux/container-supply-chain.git ~/assets/exercise-04/'
ssh root@host01 '/var/lib/openshift/openshift admin policy add-role-to-user cluster-admin admin'
