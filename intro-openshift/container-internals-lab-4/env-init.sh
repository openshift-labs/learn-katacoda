...
ssh root@host01 'ln -s ~/intro-katacoda/intro-openshift/container-internals-lab-4/assets ~/assets'
ssh root@host01 'git clone https://github.com/fatherlinux/wordpress-demo.git ~/assets/excersise-01/'
