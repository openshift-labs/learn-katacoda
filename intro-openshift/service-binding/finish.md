In this course you learnt how with the new service catalog and builtin in template service broker for OpenShift 3.7, you can easily link a database to an application.
