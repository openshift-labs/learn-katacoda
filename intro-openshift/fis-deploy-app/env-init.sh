ssh root@host01 "echo 'Debugging Initialization'"
...
#ssh root@host01 "oc replace -f https://raw.githubusercontent.com/jboss-fuse/application-templates/master/fis-image-streams.json"
