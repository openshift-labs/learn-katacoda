...
![Adding a Route](../../assets/intro-openshift/deploying-python/03-select-create-route.png)
...
![Route Details](../../assets/intro-openshift/deploying-python/03-create-route-details.png)
...
![Exposed Route](../../assets/intro-openshift/deploying-python/03-exposed-route-url.png)

Click on the URL and a new browser window should open showing the sample application.

![Sample Application](../../assets/intro-openshift/deploying-python/03-sample-blog-application.png)
