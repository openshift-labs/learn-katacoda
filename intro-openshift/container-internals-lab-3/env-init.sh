...
ssh root@host01 'cp container-internals-lab-3/exercise-01/atomic-openshift-master.service /etc/systemd/system/atomic-openshift-master.service'
ssh root@host01 'systemctl disable --now origin.service; systemctl enable --now atomic-openshift-master.service'
