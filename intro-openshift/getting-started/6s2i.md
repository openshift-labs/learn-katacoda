...
Head back to the *Overview* page when the build completes to see the image being deployed and made running. If only the summary for the deployment is shown, select the arrow to the left of the deployment name, to expand the full detail.
