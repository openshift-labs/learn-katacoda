...
ssh root@host01 -c "oc adm registry -n default --config=/openshift.local.config/master/admin.kubeconfig"
ssh root@host01 -c "docker pull centos/python-35-centos7:latest"
ssh root@host01 -c "docker pull openshiftroadshow/parksmap-katacoda:1.0.0"
