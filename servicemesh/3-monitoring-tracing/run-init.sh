...
ssh root@host01 "mvn package -f /root/projects/istio-tutorial/recommendation/java/ -DskipTests"
ssh root@host01 "docker build -t example/recommendation:v1 /root/projects/istio-tutorial/recommendation/java/"
ssh root@host01 "oc apply -f <(/root/installation/istio-0.6.0/bin/istioctl kube-inject -f /root/projects/istio-tutorial/recommendation/java/src/main/kubernetes/Deployment.yml) -n tutorial"
ssh root@host01 "oc create -f /root/projects/istio-tutorial/recommendation/java/src/main/kubernetes/Service.yml -n tutorial"
