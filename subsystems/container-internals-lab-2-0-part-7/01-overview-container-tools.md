In this lab we're going to cover a plethora of container tools available in the Red Hat Enterprise Linux (RHEL) ecosystem, including Podman, Buildah, Skopeo, CRIU and Udica. Before we get into the specific tools, it's important to understand how these are tools are provided to the end user in the Red Hat ecosystem.
