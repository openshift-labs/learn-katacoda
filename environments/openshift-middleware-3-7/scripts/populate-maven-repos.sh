...
SOURCE_REPOS=( https://github.com/hguerrero/amq-examples.git https://github.com/openshift-katacoda/rhoar-getting-started.git https://github.com/redhat-developer-demos/istio-tutorial.git https://github.com/apache/incubator-openwhisk-devtools )
