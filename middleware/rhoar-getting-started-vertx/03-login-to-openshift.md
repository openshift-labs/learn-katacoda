...
![OpenShift Console Tab](../../assets/intro-openshift/rhoar-getting-started-vertx/openshift-console-tab.png)

The first screen you will see is the authentication screen. Enter your username and password and 
then login:

![Web Console Login](../../assets/intro-openshift/rhoar-getting-started-vertx/login.png)
...
![Web Console Projects](../../assets/intro-openshift/rhoar-getting-started-vertx/projects.png)
...
![Web Console Overview](../../assets/intro-openshift/rhoar-getting-started-vertx/overview.png)
