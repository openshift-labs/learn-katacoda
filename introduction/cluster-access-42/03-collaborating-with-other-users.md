...
![View Project Membership](../../assets/introduction/cluster-access-42/03-view-project-membership.png)

You will see that only the ``developer`` user is a member of the project. Select _Edit Membership_.

![Edit Project Membership](../../assets/introduction/cluster-access-42/03-edit-project-membership.png)
...
![Add Member to Project](../../assets/introduction/cluster-access-42/03-add-member-to-project.png)
